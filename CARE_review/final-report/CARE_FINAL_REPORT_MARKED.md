---
title: "Scaling Three High-Impact Nutrition Interventions"
subtitle: "Evidence, cost, targeting and implementation — a report for CARE and IA partners"
date: "August 2026"
---
...
![**Figure 1.** Effect estimates for each intervention, in the population each was measured in. Interventions are not comparable to one another on this scale.](figures/fig1_forest.png){width=6.5in}
...
![**Figure 2.** Cost per DALY averted.](figures/fig2_cost.png){width=6.5in}
...
![**Figure 3.** The two burden variables that drive siting.](figures/fig3_targeting.png){width=6.5in}
...
![**Figure 4.** Two leaks in the treatment cascade.](figures/fig4_cascade.png){width=6.5in}
