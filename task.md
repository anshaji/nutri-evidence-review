...
- [x] Document PICOS in a shared format for Liz review → `CARE_review/docs/PICOS_specification.md` (v0 draft 2026-07-22)
...
- [x] PICOS specification document → `CARE_review/docs/PICOS_specification.md` (v0)
...
- [x] Retrieval validated & final: cmam 500, breastfeeding 640, mms 531 = 1,671 papers → `CARE_review/data/`
- [x] Add `bf_delivery_setting` (facility/community/both) + `comparison_type` + `implementation_findings` to extraction prompt → `CARE_review/prompts/deepdive_extraction_prompt.md`
...
### Outputs
- [x] Per-intervention evidence database → `CARE_review/data/evidence_db.json` (interim, 260 records)
- [x] Per-intervention synthesis sections → `CARE_review/data/synthesis_sections/{cmam_sam_mam,breastfeeding,anc_mmn}.md`
...
| 2026-07-22 | PICOS specification (3 interventions, dual-axis) | `CARE_review/docs/PICOS_specification.md` |
